...
public class FotoKTPScreen extends AppCompatActivity {
    ...
    void init_data_session(){
        ...
        progressd.show();
        Ion.with(this)
                .load("POST","https://oob.mandiriwhatthehack.com/api/submitImageKTP")
             //   .addHeader("Content-Type","multipart/form-data")
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        progressd.dismiss();
                        if (result == null)  Toast.makeText(FotoKTPScreen.this, "Mohon Dicoba Lagi", Toast.LENGTH_SHORT).show();
                        if (result.get("message").getAsString().equals("KTP Image Stored")){
                            Toast.makeText(FotoKTPScreen.this, "Submit Sukses!", Toast.LENGTH_SHORT).show();
                            JsonObject jsonarr = result.getAsJsonObject("data");
                            editor = pref.edit();
                            editor.putString("BEARER_JWT",jsonarr.get("token").getAsString());
                            editor.commit();
                            Intent intent = new Intent(getApplicationContext(), FotoDiriScreen.class);
                            startActivity(intent);
                        }
                        else {
                            Toast.makeText(FotoKTPScreen.this, "Mohon Dicoba Lagi, error : " + result.get("message").getAsString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
        ...
        Ion.with(this)
                ...
                .setCallback(new FutureCallback<String>() {
                    ...
                    public void onCompleted(Exception e, String result) {
                        ...
                        else Toast.makeText(FotoKTPScreen.this,"Error! Silahkan Coba Kembali", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor = pref.edit();
        setContentView(R.layout.fotoktp_layout);
        btNext = findViewById(R.id.fotoktp_btn_next);
        btTakePhoto = findViewById(R.id.fotoktp_btn_opencam);
        imKtp = findViewById(R.id.fotoktp_iv_ktp);
        set_btnext_click();
